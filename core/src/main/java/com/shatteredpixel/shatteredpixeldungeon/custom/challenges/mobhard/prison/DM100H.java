        ...
        protected void lightningStrike(){
            ...
            Actor.addDelayed(new Actor() {
                                 ...
                                 public boolean act(){
                                     ...
                                     //use invisible lightning to postpone time, and lock actions.
                                     aim.sprite.parent.add(new Lightning(aim.sprite.center().clone().offset(1000f,1000f), aim.sprite.center().clone().offset(1000f,1000f),
                                             new Callback() {
                                                 @Override
                                                 public void call() {
                                                     ...
                                                     aim.damage(Random.Int(30, 40), new SkyLightning());
